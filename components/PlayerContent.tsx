  ...
  return (
    <div className="grid h-full grid-cols-2 md:grid-cols-3">
      ...
      <div className="col-auto flex w-full items-center justify-end md:hidden">
        <div
          onClick={handlePlay}
          className="h-10w-10 flex cursor-pointer items-center justify-center rounded-full bg-white p-1"
        >
      ...
      <div className="hidden h-full w-full max-w-[722px] items-center justify-center gap-x-6 md:flex">
        ...
        <div
          onClick={handlePlay}
          className="w-10cursor-pointer flex h-10 items-center justify-center rounded-full bg-white p-1"
        >
          <Icon size={30} className="text-black" />
        </div>
        <AiFillStepForward
